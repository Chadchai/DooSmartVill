...
if (role == 'Committee') {
 ...
 document.getElementById("receiptlist1").href = "/getreceiptlist/Bearer " + token1;
 document.getElementById("allinvoice1").href = "/getallinvoice/Bearer " + token1;
 document.getElementById("allreceipt1").href = "/getallreceiptlist/Bearer " + token1;
 ...
 document.getElementById("allexpense1").href = "/getexpenselist1/Bearer " + token1;
