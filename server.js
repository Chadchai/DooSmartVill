...
app.get('/receiptform3/:groupid/:house_no/:receiptno/:token',authenticateJWT, receiptform);
app.get('/getrcpowner/:groupid/:house_no',getrcpowner);
app.get('/advanceinvoice', advanceinvoice);
app.get('/getownername/:village_id/:groupid/:house_no', getownername);
app.get('/getinvoicelist/:token',authenticateJWT, getinvoicelist);
app.get('/invoiceform/:groupid/:house_no', invoiceform);
app.get('/invoiceform1/:groupid/:house_no/:token',authenticateJWT, invoiceform1);
...
app.get('/gethouseinfo/:groupid/:house_no', gethouseinfo);
